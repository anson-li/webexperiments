      ...
      <div className="drumheller-section three">
        <div className="drumheller-section-three">
          ...
          <div className="bottom-image-title">
            <InView as="div" className="upper-text" ref={(e) => { this.sectiononepartonebottom = e; }} delay={100} triggerOnce onChange={(inView, entry) => this.props.animateInDiv(inView, entry)}>
